                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tr>
                        <td align="center" style="padding: 50px 40px 20px 40px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" bgcolor="#ecfdf5" style="border-radius: 50%; padding: 20px;">
                                        <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" width="50"
                                            height="50" alt="Success" style="display: block;">
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px 20px 40px; color: #64748b; font-size: 16px; line-height: 24px;">
                            Hello <strong>{{ @$body['user_name'] }}</strong>, your refund request for Order <strong>#{{ @$body['order_no'] }}</strong> has been approved.
                        </td>
                    </tr>

                    <tr>
                        <td align="center" style="padding: 0 40px 30px 40px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f8fafc; border-radius: 16px; border: 1px solid #e2e8f0; padding: 20px;">
                                <tr>
                                    <td style="color: #64748b; font-size: 14px; line-height: 22px;">
                                        <strong>Refund Reference:</strong> {{ @$body['refund_no'] }}<br />
                                        <strong>Approved Amount:</strong> {{ @$body['amount'] }}<br />
                                        <strong>Admin Note:</strong> {{ @$body['admin_notes'] }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #64748b; font-size: 13px; line-height: 20px;">
                                        <strong>Questions?</strong> If you have any questions about this refund, please contact our <a href="#" style="color: #10b981; text-decoration: none; font-weight: bold;">support team</a>.
                                    </td>
                                </tr>
                            </table>
                        </td>
